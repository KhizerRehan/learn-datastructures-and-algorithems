...
var detectCapitalUse = function (word) {
  ...
  if (
    wordLength === 0 ||
    (wordLength === 1 && word.charCodeAt() >= 65 && word.charCodeAt() <= 90)
  ) {
    return true;
  } else {
    // USA
  ...
  if (counter > 1 && counter < wordLength) return false;
  // "LeetCode"
...
(function () {
  ...
  (function () {
    ...
    const detectCapitalUse = (word) => {
      ...
      return (
        [...word].every((char) => isCapital(char)) ||
        [...word.substring(1)].every((char) => isLower(char))
      );
    };
    console.log(detectCapitalUse("LEETCODE"));
    console.log(detectCapitalUse("leetcode"));
  ...
  (function () {
    ...
    var detectCapitalUse = function (word) {
      ...
      if (
        str[0].toUpperCase() &&
        str.slice(1).every((element) => element === element.toLowerCase())
      ) {
        return true;
      }
  ...
  (function () {
    ...
    var detectCapitalUse = function (word) {
      ...
      return (
        upper === word ||
        lower === word ||
        (upper[0] === word[0] && lower.slice(1) === word.slice(1))
      );
    };
  ...
  (function () {
    ...
    var detectCapitalUse = function (word) {
      let rules = {
        ...
        titleCase: (s) =>
          s[0] === s[0].toUpperCase() && rules.lowerCase(s.slice(1)),
      };
  ...
  (function () {
    ...
    var detectCapitalUse = function (word) {
      ...
      for (let i = 0; i < word.length; i++) {
        areAllCaps =
          areAllCaps && 65 <= word.charCodeAt(i) && word.charCodeAt(i) <= 90
            ? true
            : false;
        areAllLow =
          areAllLow && 97 <= word.charCodeAt(i) && word.charCodeAt(i) <= 122
            ? true
            : false;
        ...
        isFirstCup =
          isFirstCup && 97 <= word.charCodeAt(i) && word.charCodeAt(i) <= 122
            ? true
            : false;
      }
  ...
  // ---------------------------------------------------
  // Solution-10: ChatGpt
  // https://leetcode.com/problems/detect-capital/submissions/1750719019/
  // ---------------------------------------------------
  (function () {
    function detectCapitalUse(word): boolean {
      return (
    ...
    // Wrong usage: last letter uppercase
    console.log(detectCapitalUse("javA")); // false
    // Wrong usage: mixed capitals in middle
    ...
    console.log(detectCapitalUse("aA")); // false
  	console.log(detectCapitalUse(""); // true
  })()
);
